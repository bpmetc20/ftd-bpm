...
public class ProjectStartupDate extends AbstractCustomUserTask {
	...
	@Property(type = PropertyType.DATE_PICKER, displayName = "Start date", required = true)
